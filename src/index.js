...
export const store33 = createStore(reducers, initialState);
...
ReactDOM.render(
  <Provider store={store33}>
    <App
      dimension={3}
      size={120}
      image="https://www.artscalendar.com/wp-content/uploads/sites/www.artscalendar.com/images/2018/05/Sacred-Art-Tour_1601191-400x400.jpg"
    />
  </Provider>,
...
ReactDOM.render(
  <Provider store={store55}>
    <App
      dimension={5}
      size={75}
      image="https://d3dk2sm57sh93q.cloudfront.net/Freepackers/Activities/en--LAO02-volontariat-laos-novices-thumb.jpg"
    />
  </Provider>,
